...
const ProductDetails = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/api/v1/product/singleproduct/${id}`).then(
      (res) => setSingleProducts(res.data.data),
    ...
    <>
      <div className="py-6">
        <Container>
          ...
          <Flex>
            <p
              className={"text-base font-bold uppercase text-hoverC mr-20 mb-6"}
            >
              Size :
            </p>
          ...
          <Flex>
            <button
              className={
                "py-4 px-10 border-2 border-hoverC text-sm font-bold text-hoverC mr-5"
              }
            >
              Add to Wish List
            </button>
            <button
              className={
                "py-4.5 px-11 bg-hoverC text-sm font-bold text-white mr-5"
              }
            >
              Add to Cart
            </button>
